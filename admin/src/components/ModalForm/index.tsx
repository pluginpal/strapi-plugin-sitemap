...
const ModalForm = (props) => {
  ...
  const [patternInvalid, setPatternInvalid] = useState({ invalid: false, message: null });
  const { formatMessage } = useIntl();

  const hasPro = useSelector((state: any) => state.getIn(['sitemap', 'info', 'hasPro'], false));
  ...
  useEffect(() => {
    setPatternInvalid({ invalid: false, message: null });
